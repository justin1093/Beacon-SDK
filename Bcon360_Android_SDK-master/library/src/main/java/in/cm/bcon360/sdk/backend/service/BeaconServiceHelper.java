 ...
 */
      ...
      //
       // configurations.triggers.add(obj1Trigger);
        ...
        Action.Payload payload1 =new Action.Payload();
        payload1.url="http://auditor-thomas-10740.bitballoon.com/";
       ...
       GetConfigurationsResponse.Trigger.Condition con1 = new GetConfigurationsResponse.Trigger.Condition();
        ...
        obj1Trigger.action.payload=payload1;
        //enumeration
...
// Ad Beacon
        ...
        BeaconProximity proxAd = new BeaconProximity("9D07149D-23D5-4B30-BA5A-5214346460AF+4104+3186");
        rangeAd.id= 7;
        rangeAd.name="Beacon 9";
        rangeAd.protocol= GetConfigurationsResponse.Range.Protocol.iBeacon;
        rangeAd.proximityId= proxAd;

        Action.Payload payloadAd =new Action.Payload();
        payloadAd.url="http://packer-locomotive-21471.bitballoon.com/";
        ...
        objTriggerAd.action.payload=payloadAd;
        //enumeration
       ...
       // Action.Type typeAd= Action.Type.coupon;
        ...
        objTriggerAd1.action.payload=payloadAd1;
        //enumeration
